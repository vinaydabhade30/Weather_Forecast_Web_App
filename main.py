...
# Assign streamlit objects

st.header("Weather Forecast for the Next Days")

place_input = st.text_input("Place:", placeholder="Enter Place Name")

forecast_days_sld = st.slider("Forecast Days", min_value=1, max_value=5, help='Select Days for Weather Forecast')
...
# get place_input value
if place_input:
    try:
        # Call function backend
